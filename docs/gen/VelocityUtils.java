...
public class VelocityUtils {
  ...
  public static String getFileName(String template, GenTable genTable) {
    ...
    if (template.contains("sub-domain.java.vm")
      ...
      fileName =
          StringUtils.format("{}/domain/{}.java", javaPath, genTable.getSubTable().getClassName());
      ...
      fileName =
          StringUtils.format(
              "{}/views/{}/{}/modules/CreateForm.vue", vuePath, moduleName, businessName);
    } else if (template.contains("index-tree.vue.vm")) {
      fileName = StringUtils.format("{}/views/{}/{}/index.vue", vuePath, moduleName, businessName);
    } else if (template.contains("SubTable.vue.vm")) {
      fileName =
          StringUtils.format(
              "{}/views/{}/{}/modules/SubTable.vue", vuePath, moduleName, businessName);
    } else if (template.contains("CreateSubForm.vue.vm")) {
      fileName =
          StringUtils.format(
              "{}/views/{}/{}/modules/CreateSubForm.vue", vuePath, moduleName, businessName);
    }
