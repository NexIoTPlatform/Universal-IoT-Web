...
import {updateColorWeak, updateTheme} from '../../utils/dynamicTheme'
    ...
    return (
      ...
      >
        <template slot="handle">
          <div class={`${baseClassName}-handle`}
               onClick={() => setShow(!this.show)}>
            {this.show
              ? (<Icon type="close" style={iconStyle}/>)
              : (<Icon type="setting" style={iconStyle}/>)
            }
        ...
        <div class={`${baseClassName}-content`}>
          <Body title={i18n('app.setting.pagestyle')}>
            <BlockCheckbox i18nRender={i18n} list={themeList.themeList}
          ...
          <ThemeColor
            ...
            value={primaryColor}
            colors={themeList.colorList[theme === 'realDark' ? 'dark'
              : 'light']}
            onChange={(color) => {
          ...
          <Body title={i18n('app.setting.navigationmode')}>
            <BlockCheckbox i18nRender={i18n} value={layout}
                           onChange={(value) => {
              ...
              dataSource={[
                {
                  ...
                  action: (
                    <Switch
                      size="small"
                      checked={!!colorWeak}
                      onChange={(checked) => changeSetting('colorWeak',
                        checked)}
                    />
                  )
                }
