...
export const BasicLayoutProps = {
  ...
  footerRender: PropTypes.oneOfType([PropTypes.func, PropTypes.bool]).def(
    undefined)
}
...
const BasicLayout = {
  ...
  render(h, content) {
    ...
    const rightContentRender = getComponentFromProp(content,
      'rightContentRender')
    const collapsedButtonRender = getComponentFromProp(content,
    ...
    const headerContentRender = getComponentFromProp(content,
      'headerContentRender')
    ...
    return (
      <ConfigProvider i18nRender={i18nRender} contentWidth={props.contentWidth}
