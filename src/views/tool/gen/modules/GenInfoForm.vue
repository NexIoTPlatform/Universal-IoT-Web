    ...
    >
      <a-row>
        ...
        <a-col :span="24" v-if="info.genType == '1'">
          <a-form-model-item :labelCol="{ xs: { span: 6 },sm: { span: 3 } }"
            ...
            <a-input v-model="info.genPath">
              <a-dropdown slot="suffix">
                <a-button style="width:100%;"> 最近路径快速选择
                  <a-icon type="down"/>
                </a-button>
                <a-menu slot="overlay">
        ...
        <a-col :span="12">
          <a-form-model-item>
            ...
            <a-select v-model="info.treeCode" placeholder="请选择">
              <a-select-option v-for="(item, index) in info.columns" :key="index"
        ...
        <a-col :span="12">
          <a-form-model-item>
            ...
            <a-select v-model="info.subTableFkName" placeholder="请选择">
              <a-select-option v-for="(item, index) in subColumns" :key="index"
                               :value="item.columnName">
                {{ item.columnName + '：' + item.columnComment }}
              </a-select-option>
            </a-select>
