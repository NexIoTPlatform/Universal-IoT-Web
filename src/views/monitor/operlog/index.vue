            ...
            <template v-if="advanced">
              <a-col :md="8" :sm="24">
                <a-form-item label="类型">
                  <a-select placeholder="操作类型" v-model="queryParam.businessType"
              ...
              <a-col :md="8" :sm="24">
                <a-form-item label="状态">
                  <a-select placeholder="操作状态" v-model="queryParam.status" style="width: 100%"
                            allow-clear>
  ...
  methods: {
    ...
    handleExport() {
      ...
      this.$confirm({
        ...
        onOk() {
          that.download('admin/monitor/operlog/export', {
            ...that.queryParam
