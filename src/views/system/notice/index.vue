          ...
          <a-row :gutter="48">
            <a-col :md="8" :sm="24">
              <a-form-item label="公告标题">
                <a-input v-model="queryParam.noticeTitle" placeholder="请输入"
            ...
            <template v-if="advanced">
              <a-col :md="8" :sm="24">
                <a-form-item label="公告类型">
                  <a-select placeholder="请选择" v-model="queryParam.noticeType" style="width: 100%"
                            allow-clear>
    ...
    <a-card :bordered="false" class="table-card">
      ...
      <a-table
        ...
        <span slot="operation" slot-scope="text, record">
          <a-space>
            <a-button type="link" icon="edit" @click="handleUpdate(record, undefined)"
