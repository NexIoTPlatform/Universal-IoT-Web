  ...
  <a-card :bordered="false">
    ...
    <div class="table-operations">
      ...
      <a-button type="primary" @click="$refs.importForm.handleImport()"
                v-hasPermi="['product:device:import']">
        <a-icon type="import"/>
        导入
      </a-button>
      ...
      <!-- <a-button type="primary" @click="handleExport" v-hasPermi="['system:instance:export']">
        <platform-icon type="icon-u-export"/>导出
      </a-button> -->
      <a-button
        type="primary"
        size="small"
...
import ChildDeviceCreateForm from './ChildDeviceCreateForm'
import ChildDeviceImportForm from './ChildDeviceImportForm.vue'
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true
      this.queryParam.parentId = this.devId
